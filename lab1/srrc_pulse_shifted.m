function [phi, t] = srrc_pulse_shifted(T, over, A, a, k)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [phi, t] = srrc_pulse(T, over, A, a, k)                                          %
%                                                                               %
% OUTPUT                                                                        %    
...
%      k:  number of periods the signal is to be shifted (integer)              %
%                                                                               %
%    A. P. Liavas, Oct. 2020                                                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Create time axis
t = [-A*T - k*T :Ts: A*T - k*T] + 10^(-8); % in order to avoid division by zero problems at t = -K*T .
